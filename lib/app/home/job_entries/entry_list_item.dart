...
import 'package:first/app/home/models/entry.dart';
...
class EntryListItem extends StatelessWidget {
  ...
  Widget _buildContents(BuildContext context) {
    ...
    return Column(
      ...
      children: <Widget>[
        Row(children: <Widget>[
          Text(dayOfWeek, style: TextStyle(fontSize: 20.0, color: Colors.grey)),
          SizedBox(width: 15.0),
          Text(startDate, style: TextStyle(fontSize: 20.0)),
          if (job.ratePerHour > 0.0) ...<Widget>[ //Collection-if '...' are known as spread operator
        ...
        Row(children: <Widget>[
          Text('$startTime - $endTime', style: TextStyle(fontSize: 18.0)),
          Expanded(child: Container()),
          Text(durationFormatted, style: TextStyle(fontSize: 18.0)),
        ]),
